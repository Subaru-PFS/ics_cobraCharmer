...
class App(tk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.infolvl.set(1)
        self.radio1 = tk.Radiobutton(frameRadio, text="Simple",
                                     variable=self.infolvl, value=1, command=self.update)
        self.radio2 = tk.Radiobutton(frameRadio, text="Detailed",
                                     variable=self.infolvl, value=2, command=self.update)
        self.radio3 = tk.Radiobutton(frameRadio, text="Full",
                                     variable=self.infolvl, value=3, command=self.update)
