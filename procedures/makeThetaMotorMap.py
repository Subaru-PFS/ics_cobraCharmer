...
def runThetaMotorMap(repeat, steps, storagePath, outputXML):
...
def main():
    ...
    for steps in [50]:
        ...
        runThetaMotorMap(1, steps, storagePath, outputXML)
        analysisMotorImages(1, storagePath, 15000, 7000, steps, oriXML, outputXML)
