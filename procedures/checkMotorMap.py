...
def main():
    dataPath='/home/pfs/mhs/devel/ics_cobraCharmer.cwen/xml/'
    xml1=dataPath+'motormaps_181205.xml'
    figpath='/dada/pfs/MotorMap/20190109/'
    ...
    for i in visibles:
        ...
        q = figure(tools=TOOLS, x_range=[0, 400], y_range=[-0.3,0.3],plot_height=400,plot_width=545)
        ...
        xml2=dataPath+f'motormap20190107.xml'
        print(xml2)
