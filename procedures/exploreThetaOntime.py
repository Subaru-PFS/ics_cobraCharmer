...
for t_ms in tarray:
    ...
    old.createCalibrationFile(cobraCharmerPath+f'/xml/motormapThetaOntime_{t_ms}us_'+datetoday+'.xml')


    print(cobraCharmerPath+f'/xml/motormapThetaOntime_{t_ms}us_'+datetoday+'.xml  produced!')
